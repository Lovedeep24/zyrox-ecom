              ...
              <Select
                ...
                <SelectPopover>
                  <SelectListBox className={"w-[200px]"}>
                    ...
                    <SelectItem id="sweatshirt">Sweatshirt</SelectItem>
                    <SelectItem id="jacket">Jacket</SelectItem>
                    <SelectItem id="tshirt">Tshirt</SelectItem>
                    <SelectItem id="combo">Combo</SelectItem>
                    <SelectItem id="hoodie">Hoodie</SelectItem>
                    <SelectItem id="joggers">Joggers</SelectItem>
                    <SelectItem id="vintage">Vintage</SelectItem>
                    <SelectItem id="classic">Classic</SelectItem>
                    <SelectItem id="oversized">Oversized</SelectItem>
