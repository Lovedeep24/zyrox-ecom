...
function CarouselNavigation({
  ...
  return (
    <div
      className={cn(
        'pointer-events-none absolute left-[-2%] top-1/2 flex w-[105%] -translate-y-1/2 justify-between px-2',
        className
      )}
    >
      <button
        ...
        className={cn(
          'pointer-events-auto h-fit w-fit border-2 rounded-full bg-zinc-50 p-2 transition-opacity duration-300 dark:bg-zinc-950',
          alwaysShow
            ? 'opacity-100'
