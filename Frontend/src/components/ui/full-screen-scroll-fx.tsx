      ...
      >
        ...
        <style jsx>{`
          ...
          .fx-header {
            ...
            font-size: clamp(2rem, 7vw, 7rem); line-height: 0.86; text-align: center; color: var(--fx-text);
          }
          ...
          .fx-footer-title { color: var(--fx-text); font-size: clamp(1.6rem, 3vw, 3rem); font-weight: 200; letter-spacing: -0.01em; line-height: 0.9; }
